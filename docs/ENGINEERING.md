...
The long-form detail behind the README: how each part works and, more often, why it works
that way rather than the obvious way. Written for someone reading the code, not for someone
deciding whether to read the code.

The short version, with screenshots, is in [`../README.md`](../README.md).
...
[`docs/capture.mjs`](capture.mjs) — nothing here is a mockup, and the evaluations are real
...
<p align="center">
  <img src="screenshots/02-opening-mobile.png" width="300" alt="The opening on a phone">
  &nbsp;&nbsp;
  <img src="screenshots/03-application-form.png" width="470" alt="The application form">
</p>
...
![Screening questions, with no hint of which answer is wanted](screenshots/04-screening-questions.png)
...
<p align="center">
  <img src="screenshots/05-send-confirmation.png" width="440" alt="Send your application?">
  &nbsp;&nbsp;
  <img src="screenshots/06-application-received.png" width="440" alt="Your application is in">
</p>
...
![The ranking](screenshots/08-ranking.png)
...
<p align="center">
  <img src="screenshots/21-search.png" width="420" alt="Search by surname">
</p>

Reading one application, with the list out of the way:

![One application, read with the list hidden](screenshots/10-focused-reading.png)
...
![A decision, with its reason and the provenance of the score](screenshots/22-decision.png)
...
![Stated by the applicant](screenshots/16-stated-by-applicant.png)
...
![Two candidates compared](screenshots/14-compare.png)

### Sharing a shortlist

Whoever screens is rarely whoever decides. A read-only link, minted once and shown once:

![The link, shown once](screenshots/17-share-made.png)
...
<p align="center">
  <img src="screenshots/18-shared-shortlist.png" width="620" alt="The shared shortlist">
</p>
...
![A trace of one panel request](screenshots/19-trace-waterfall.png)
...
![The traffic, in the trace search](screenshots/20-trace-search.png)
...
<p align="center">
  <img src="screenshots/07-sign-in.png" width="420" alt="Sign in">
</p>
...
<p align="center">
  <img src="screenshots/15-said-no-list.png" width="420" alt="A row marked, not hidden">
</p> The
